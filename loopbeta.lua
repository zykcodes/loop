...
Tab:Slider("Field Of View", 70, 140,0,function(t)
...
Tab:Button("Walkspeed [Z]", function()
...
Tab:Button("Juggernaut", function()
...
Tab:Toggle("Combat Reach", function(e)
...
Tab:Toggle("Auto-Reload",function(r)
...
Tab:Toggle("Anti-Slow", function(gh)
...
Tab:Button("Auto Stomp", function(r)
